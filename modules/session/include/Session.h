...
namespace frenchroast { namespace session {
    class Session  {
      ...
      std::unordered_map<std::string, frenchroast::monitor::TimerReport>  _timers;
    ...
    public:
      ...
      std::unordered_map<std::string, frenchroast::monitor::TimerReport>  get_timer_reports() const;
